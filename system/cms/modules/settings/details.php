...
class Module_Settings extends Module
{
	...
	public function install()
	{
		...
		$settings = array(
			...
			'ga_profile' => array(
				'title' => 'Google View ID',
				'description' => 'View ID for this website in Google Analytics',
				'type' => 'text',
				'default' => '',
				'value' => '',
				'options' => '',
			...
			'ga_email' => array(
				'title' => 'Google API Service Account E-mail',
				'description' => 'API Service Account E-mail address used for Google Analytics, we need this to show the graph on the dashboard.',
				'type' => 'text',
				'default' => '',
				'value' => '',
				'options' => '',
			...
			'ga_password' => array(
				'title' => 'Google API Key Path',
				'description' => 'Google API Key. This is also needed to show the graph on the dashboard. You will need to login to your Google Developers Console, and obtain a .p12 key file. Refer to <a href="https://github.com/pyrocms/pyrocms/issues/3491" target="_blank">This Issue for details</a>',
				'type' => 'text',
				'default' => '',
				'value' => '',
				'options' => '',
